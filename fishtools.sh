...
show_preset_deployment_menu() {
    while true; do
        ...
        case $preset_choice in
            1) deploy_preset_project "portainer-ce"; press_any_key ;;
            2) deploy_preset_project "homepage"; press_any_key ;;
            3) deploy_preset_project "adguard-home"; press_any_key ;;
            4) deploy_preset_project "nginx-proxy-manager"; press_any_key ;;
            0) break ;;
